...
<body>
    ...
    <!-- 3 new buttons centered and symmetrical -->
    <div class="button-container">
        <button class="btn"><i class="fas fa-hand-holding-usd"></i> View Grants</button>
        <a href="viewApplications.php"><button class="btn"><i class="fas fa-folder-open"></i> View My Applications</button></a>
        <!-- Form for Make Application -->
        <form action="makeApplication.php" method="POST">
            <input type="hidden" name="username" value="<?php echo htmlspecialchars($_SESSION['username']); ?>">
            <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
            <input type="hidden" name="email" value="<?php echo htmlspecialchars($_SESSION['email']); ?>">
            <button type="submit" class="btn"><i class="fas fa-edit"></i> Make Application</button>
        </form>
    </div>
