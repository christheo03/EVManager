...
<head>
    ...
    <style>
        ...
        .content {
            margin-top: 150px; /* Adjusted margin to reduce gap */
            width: 600px;
            text-align: center;
            padding: 30px;
...
.btn {
    padding: 15px;
    font-size: 18px;
    margin: 20px 0; /* Adds space above and below each button */
    width: 550px; /* Button width */
...
<body>
    ...
    <div class="container">
    <button class="btn" onclick="window.location.href='showApplications.php'">View Applications</button>
    <button class="btn" onclick="window.location.href='reports.php'">View Reports</button>
</div>
