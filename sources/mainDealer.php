...
<body>
    ...
    <div class="content">
        ...
        <p>You are successfully logged in as a Dealer.</p>
    </div>

    <!-- Single Button to Make Order -->
    <div class="button-container">
        <a href="dealer.php">
            <button class="btn"><i class="fas fa-cart-plus"></i> Make an Order</button>
            <a href="viewOrders.php"><button class="btn"><i class="fas fa-folder-open"></i> View Orders</button></a>
            </a>
    </div>
